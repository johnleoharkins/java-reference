 ...
 * Source: <a href="https://algs4.cs.princeton.edu/12oop/Point2D.java.html">chapterOne.Point2D Princeton</a>
 *
 *  The {@code Point} class is an immutable data type to encapsulate a
 *  two-dimensional point with real-value coordinates.
 *  <p>
 *  Note: in order to deal with the difference behavior of double and
 *  Double with respect to -0.0 and +0.0, the chapterOne.Point2D constructor converts
...
public class Point2D implements Comparable<Point2D> {
     ...
     *      is {@code Double.NaN}, {@code Double.POSITIVE_INFINITY} or {@code Double.NEGATIVE_INFINITY}
     */
